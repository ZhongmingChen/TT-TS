function X = cores_2_ttensor(cores, varargin)
%cores_2_tensor Convertes TT tensor given by cores to full dense tensor
%
%X = cores_2_tensor(cores) takes a cell array containing TT cores and
%outputs the corresponding full dense tensor. The input TT cores should be
