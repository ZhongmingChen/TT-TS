function [YsT] = sketch_from_mat_ts(J1, h1int64, s, verbose, filename, inc_size)
...
%     end
    for inc = 1:no_inc
        ...
        if n < N
            ...
            colons = repmat({':'}, 1, N-2);
            Y_piece = file.Y(colons{:}, slice_start : slice_end, :);% Sample individual dimensions in a tensor
        end
